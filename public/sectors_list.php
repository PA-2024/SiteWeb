                            ...
                            <div class="col">
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk">
                                        ...
                                        <div class="add-group">
                                            <a href="add_sectors.php" class="btn btn-primary add-pluss ms-2"><img src="assets/img/icons/plus.svg" alt=""></a>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <a class="dropdown-item" href="edit_sector.php?id=<?php echo htmlspecialchars($sector['sectors_Id']); ?>"><i class="fa-solid fa-pen-to-square m-r-5"></i> Éditer</a>
