            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-5 col-6 text-end m-b-30">
                        <a href="edit-profile.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Éditer le Profil</a>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="tel:<?php echo htmlspecialchars($user_num); ?>"><?php echo htmlspecialchars($user_num); ?></a></span>
                                                </li>
                                                <li>
