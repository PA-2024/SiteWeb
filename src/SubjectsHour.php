...
class SubjectsHour
{
    private $apiUrl = "https://apipa2024-a0a3b2c9ce54.herokuapp.com/api/SubjectsHour";
    private $token;
    ...
    public function fetchSubjectsHoursByDateRange($startDate, $endDate)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new \Exception('Erreur dans le décodage des données JSON.' . $startDate . " " . $endDate);
        }
